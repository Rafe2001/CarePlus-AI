...
LIGHT = dict(
    bg="#F0F4F8", bg2="#E2EAF4",
    card="rgba(255,255,255,0.85)", card_solid="#FFFFFF",
    border="rgba(0,137,123,0.2)", border_solid="#CBD5E1",
    text="#1A2B3C", muted="#64748B",
    accent="#00897B", accent_dk="#00695C",
    user_bubble="rgba(0,137,123,0.13)", bot_bubble="rgba(255,255,255,0.95)",
    sidebar="#DDE8F5",
...
.step-active{{ color: {t['step_active']}; font-weight: 700; }}
.step-todo  {{ color: {t['step_todo']}; opacity: 0.65; }}
...
<div style="text-align:center;padding:1.2rem 0 0.6rem 0;">
  ...
  <div class="live-badge" style="justify-content:center;margin-top:0.4rem;">
...
<div style="padding:1.25rem 0 0.5rem 0;">
  <h1 style="
    ...
    background:linear-gradient(135deg,{t['accent']},{t['accent_dk']});
    -webkit-background-clip:text;-webkit-text-fill-color:transparent;
    background-clip:text;
  ">Appointment Booking</h1>
  <p style="color:{t['muted']};font-size:0.82rem;margin:0.2rem 0 0 0;">
    CarePlus Clinic · AI-powered · Available 24/7
  </p>
</div>""", unsafe_allow_html=True)
